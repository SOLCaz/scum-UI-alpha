# Climax Controller Preface

To create a CandyMachineV2 and a ClimaxController that are compatible, do the following:

1) Create a CandyMachineV2 with any sol treasury wallet (its just a placeholder)
2) Create a ClimaxController using the CandyMachine ID from (1)
3) Update the CandyMachineV2 treasury to the "TreasuryAccountAddress" from (2)
4) Update the .env file for this UI with the CandyMachineV2 ID from (1) and the "ClimaxController ID" from (2)
...
# climax_controller_X_candy_machine_v2_ui
